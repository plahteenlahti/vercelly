...
const PrivacyPolicy = () => {
  return (
    <Layout>
      <SEO title="Vercelly Privacy Policy" />
      <Container>
        ...
        <p>
          ...
          shared and/or collect in Vercelly. This policy is not applicable to
        ...
        <p>
          Vercelly follows a standard procedure of using log files. These files
        ...
        <p>
          ...
          advertising partners of Vercelly.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Vercelly, which are sent
        ...
        <p>
          Vercelly's Privacy Policy does not apply to other advertisers or
        ...
        <p>
          Vercelly does not knowingly collect any Personal Identifiable
